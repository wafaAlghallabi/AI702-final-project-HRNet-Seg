...
from core.resnet import BasicBlock, Bottleneck
...
class LiteHRNet(nn.Module):
    ...
    def __init__(self,
        ...
        self.hanet1 = HANet_Conv(40, 40,
                            3 ,64 ,3,
                            2, 1,
                            8, "mean",
                            0.1, 0.5) 

        self.hanet2= HANet_Conv(80, 80,
                            3 ,64 ,3,
                            2, 1,
                            8, "mean",
                            0.1, 0.5) 

        self.hanet3 = HANet_Conv(160, 160,
                            3 ,64 ,3,
                            2, 1,
                            8, "mean",
                            0.1, 0.5)

        self.hanet4 = HANet_Conv(320, 320,
                            3 ,64 ,3,
                            2, 1,
                            8, "mean",
                            0.1, 0.5)
        ...
        self.hanet_list = [self.hanet1,self.hanet2,self.hanet3,self.hanet4]
    ...
    def add_HANet(self,lst_low,lst_high):
        l = len(lst_low)
        new_lst = []
        for i in range(l):
            hanet = self.hanet_list[i]
            output = hanet(lst_low[i],lst_high[i],None)
    ...
    #   - [40, 80, 160, 320]
        ...
        for i in range(self.num_stages):
            ...
            y_list = self.add_HANet(x_list,y_list)
