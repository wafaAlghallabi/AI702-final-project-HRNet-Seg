...
import math
from .mynn_HANet import Norm2d, Upsample
from .PosEmbedding_HANet import PosEmbedding1D, PosEncoding1D

from .bn_helper import BatchNorm2d #added this
...
class HANet_Conv(nn.Module):
    ...
    def __init__(self, in_channel, out_channel, kernel_size=3, r_factor=64, layer=3, pos_injection=2, is_encoding=1,
        ...
        self.pooling = pooling #type of pooling
        self.pos_injection = pos_injection 
        self.layer = layer 
        self.dropout_prob = dropout_prob 
        self.sigmoid = nn.Sigmoid() 
        #pos_rfactor: number of position information
        #r_factor: 
        ...
        self.attention_first = nn.Sequential(
                ...
                nn.BatchNorm1d(mid_1_channel), #batchnorm2d: modified 
    ...
    def forward(self, x, out, pos=None, return_attention=False, return_posmap=False, attention_loss=False):
        ...
        if pos is not None and self.pos_injection == 1: #SKIP for hanet0
            if return_posmap:
        ...
        if pos is not None and self.pos_injection == 2:  #SKIP for hanet0
            if return_posmap:
