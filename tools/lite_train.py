...
# args.seed = 304
# args.cfg = "/home/sultan.abughazal/Deep Learning/Project/experiments/experiment3/HRNet-Semantic-Segmentation/experiments/cityscapes/new_seg_litehrnet_w32_train_512x1024_sgd_lr1e-2_wd5e-4_bs_12_epoch484.yaml"
# args.local_rank = -1
# args.opts = []
...
model = LiteHRNet(config.MODEL.EXTRA, config.MODEL.EXTRA.in_channels)
